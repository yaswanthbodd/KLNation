...
export const Timeline = ({
    ...
    return (
        ...
        <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
            ...
            Kannur Lokesh Rahul was born 18 April 1992 in Mangalore to Dr. K. N. Lokesh (NITK professor) and Rajeshwari (university lecturer).<br/> Started formal training at age 10, played U‑14 and U‑16 Karnataka teams, moved to Bangalore at ~17 to train at KSCA and study at Jain University
            </p>
        </div>
